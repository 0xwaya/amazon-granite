...
2. Lead delivery wiring is confirmed:
...
2. Verify Vercel project linkage strategy:
...
- Webhook receipt
3. In a low-traffic window, switch production source to urbanstone.
4. Monitor first deployment logs to completion.
5. Run immediate production checks:
- Open homepage
