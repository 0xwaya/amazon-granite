...
export default function CommercialEstimateAssistant({ tiers, collapsible = false, defaultExpanded = true }) {
    ...
    return (
        <section id="commercial-estimate" className="rounded-[2rem] border border-border bg-surface/90 p-5 shadow-soft sm:p-7">
            {collapsible && !showForm ? (
                <div className="flex justify-center">
                    <button
                        type="button"
                        className="brand-button-primary px-8 py-3 text-base font-semibold"
                    ...
                    <form className="rounded-[1.9rem] border border-border bg-panel/90 p-5 sm:p-6" onSubmit={handleSubmit}>
                        {collapsible && (
                            <div className="flex justify-end mb-2">
                                <button
                                    type="button"
                                    className="rounded-full border border-border bg-panel px-4 py-2 text-sm font-semibold text-muted hover:border-accent hover:text-accent"
