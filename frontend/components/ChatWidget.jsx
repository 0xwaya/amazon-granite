...
export default function ChatWidget() {
    ...
    return (
        <aside className="pointer-events-none fixed bottom-4 right-4 z-50 hidden max-w-xs md:block">
            <div className="pointer-events-auto rounded-3xl border border-border bg-surface/90 p-4 shadow-soft backdrop-blur">
                <div className="eyebrow">Fast response</div>
                <div className="font-display text-3xl font-semibold">Need a countertop estimate today?</div>
